...
// This section previously contained UV light and watering system controls.
// These features have been removed as per user request to simplify the application.
// The application now focuses only on passive monitoring (temperature and humidity).
